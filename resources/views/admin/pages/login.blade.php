...
<head>
    ...
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, shrink-to-fit=no"
        name="viewport">
    <title>Login2 &mdash; Stisla</title>
        ...
        <section class="section">
            <div class="d-flex align-items-stretch flex-wrap">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="m-3 p-4">
                        <img src="{{ asset('customer/img/short-icon.png') }}"
                            alt="logo"
                            width="80"
                            class="shadow-light rounded-circle mb-3 mt-2">
                        {{-- <h4 class="text-dark font-weight-normal">Selamat Datang <span class="font-weight-bold">Admin</span>
                        </h4> --}}
                        ...
                        <div class="text-small mt-5 text-center">
                            Copyright &copy; Gudang Jember Coffe Centre. Made with ❤️ by GoodMan
                        </div>
                    </div>
                </div>
